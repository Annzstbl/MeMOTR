...
from ..model_20260317.deformable_transformer_20260317 import DeformableTransformer20260317
from ..model_20260317.deformable_transformer_20260317 import build as build_deformable_transformer
from ..ffn import FFN
from ..mlp import MLP
from ..position_embedding_rope_nd import build as build_rope_pos
from ..query_updater import build as build_query_updater
from .SCEM_20260330 import build as build_scem
from ..utils import get_clones, logits_to_scores, pos_to_pos_embed
from torch.utils.checkpoint import checkpoint

from ..model_20260317.memotr_20260317 import MeMOTR20260317


class MeMOTR20260320(MeMOTR20260317):
    def __init__(self, backbone: BackboneWithPE, transformer: DeformableTransformer20260317,
        ...
        '''
            20260310
        '''
        super(MeMOTR20260317, self).__init__()
