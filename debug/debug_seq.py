...
def main():
    ...
    parser.add_argument("--csv-output-dir", type=str, default="encoder_tensor_csvs",
    ...
    parser.add_argument("--heatmap-dir", type=str, default="encoder_tensor_maps",
    ...
    parser.add_argument("--project-name", type=str, default="seq_scem",
    ...
    parser.add_argument("--seq", type=str, help="Sequence folder name to read first frame from.", default='data43-2')
            ...
            if 'scores' in heatmap_outputs:
                try:
                    if isinstance(outputs, dict) and ('scores' in outputs) and ('pred_bboxes' in outputs):
                        ...
                        # 2) 再画统一粗细的旋转框
                        for i, poly in enumerate(boxes_xyxyxyxy):
